import svgPaths from "./svg-tt2xgrbx7d";
...
import { imgBase, imgMastercard, imgStripe, imgRectangle773, imgRectangle772, imgVector, imgVector1 } from "./svg-d8ai8";
    ...
    return (
      <div className={className} data-name="Card=Mastercard">
        ...
        <div className="absolute inset-[18.75%_16.67%_19.9%_16.67%]" data-name="Mastercard">
          <img alt="" className="block max-w-none size-full" src={imgMastercard} />
        </div>
      </div>
    );
  }
